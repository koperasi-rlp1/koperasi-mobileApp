...
import 'package:flutter_task_planner_app/screens/sign_payment.dart';
...
class OtpPage  extends StatefulWidget {
  ...
  @override
  OtpView createState() => OtpView();
}

class OtpView extends State<OtpPage> {
              ...
              FadeAnimation(
                      ...
                      GestureDetector(
                          ...
                          onTap: () {
                            Navigator.push(
                              context,
                              MaterialPageRoute(builder: (context) => SignPaymentPage()),
                            );
                          }))
            ],
          ),
